...
import { faTimesCircle, faHome, faShoppingCart, faComment, faUser, faMinus, faPlus, faSearch, faClose,faCommentDots, faCartPlus, faAngleLeft } from '@fortawesome/free-solid-svg-icons'
	...
	<Modal isVisible={this.state.showModal}>
		...
		<View >
		  ...
		  <View style={{width: width, height: 75, backgroundColor: '#fed3be', position: 'relative'}}>
				...
				<TouchableOpacity onPress={() =>this.props.navigation.goBack()}  style={{position:'absolute', left: 15, top: 37}}>
